            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-5 my-10'>
                <div className="card card-compact w-full bg-base-100 shadow">
                    ...
                    <div className="card-body mt-8">
                        ...
                        <p>The customer service at this shop is exeptional.They went above and beyond to help me find the perfect toy. Appriciate the focus on sustainable and eco-freindly toys at this shop. Its so important our kids</p>

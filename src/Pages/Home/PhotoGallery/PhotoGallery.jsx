...
const PhotoGallery = () => {
    return (
        <div className='my-10'>
            ...
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ut soluta iusto dolores hic nobis vero sed tempora, pariatur maxime, dolor mollitia! Placeat, <br /> ab quas nobis eos praesentium numquam unde esse sapiente sint at reiciendis ad excepturi, repellendus explicabo optio quasi qui repellat dolor a. Voluptate maxime eaque architecto reprehenderit nam!</p>
            </div>
